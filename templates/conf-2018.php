...
<head>
  ...
  <meta name="title" content="BrazilJS Conf 2018 - Edição Porto Alegre!">
  <meta name="description" content="BrazilJS Conf ! A edição Porto Alegre ocorre nos dias 25 e 26 de Agosto.">

  <link rel="apple-touch-icon" sizes="180x180" href="https://braziljs.org/wp-content/themes/braziljs/apple-touch-icon.png">
  <link rel="icon" type="image/png" href="https://braziljs.org/wp-content/themes/portal-wp-theme-master/favicon-32x32.png" sizes="32x32">
  <link rel="icon" type="image/png" href="https://braziljs.org/wp-content/themes/portal-wp-theme-master/favicon-16x16.png" sizes="16x16">
  ...
  <!-- FACEBOOK -->
  <meta property="og:url" content="https://braziljs.org/conf" />
  <meta property="og:site_name" content="BrazilJS" />
  <meta property="article:tag" content="brazils conf" />
  <meta property="article:section" content="BrazilJS Conf 2018" />
  ...
  <meta property="og:image" content="https://braziljs.org/wp-content/themes/portal-wp-theme-master/assets/img/social-networks/braziljs-8a25d9c389.jpg" />
  ...
  <meta name="twitter:image" content="https://braziljs.org/wp-content/themes/portal-wp-theme-master/assets/img/social-networks/braziljs-8a25d9c389.jpg" />
    ...
    <section class="content conf-teaser">
      ...
      <div class="braziljs">
        ...
        <div class="lead">
          ...
          <div class="ingresse-widget" data-aos="fade-up" data-aos-easing="ease" data-aos-delay="1200" data-btntext="Comprar Ingressos" data-btnbgcolor="#ffdd16" data-btntextcolor="#000" data-eventid="23468" ></div>
          <p class="address"> Porto Alegre, RS - BarraShopping Sul</p>
        </div>
      </div>
      <div class="timer">
      ...
      <div class="speaker-grid">
        <h3 id="keynotes" class="alt-h3">Keynotes confirmados</h3>
          ...
          <li class="speaker-item">
            <div class="speaker-info">
              ...
              <div class="speaker-bio">
                ...
                <p>
                  Developer Advocate da Samsung para o navegador <a href="https://twitter.com/SamsungInternet">@SamsungInternet</a>. Web fangirl. Geralmente em Londres. WebXR Device API, Web Components, PWA.
                </p>
              </div>
            </div>
          </li>
          <li class="speaker-item">
            <div class="speaker-info">
              ...
              <div class="speaker-bio">
                <h3>Kyle Simpson</h3>
                <p>
                  Kyle Simpson é um evangelista da Open Web, apaixonado por todas as coisas relacionadas ao JavaScript. Ele é um escritor, palestrante, professor e contribuidor em projetos open-source.
                </p>
              </div>
            </div>
          </li>
          <li class="speaker-item">
            <div class="speaker-info">
              ...
              <div class="speaker-bio">
                ...
                <p>
                  Programador, designer, professor e cientista louco. Atualmente, construindo o <a href="https://webtorrent.io/">WebTorrent</a>, um cliente de streaming BitTorrent para o navegador, alimentado pela WebRTC. Antes disso, construiu o <a href="https://web.archive.org/web/20150810065820/https://peercdn.com/">PeerCDN</a>, uma rede de entrega de conteúdo peer-to-peer para tornar os sites mais rápidos e mais baratos.
                </p>
              </div>
            </div>
          </li>
          <li class="speaker-item">
            <div class="speaker-info">
              <div class="speaker-img">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLScvM9sctUCe2vjbUxv3QzhRimn5ztB7JyPgbnpTDksS3eTpQw/viewform"><div class="speaker__image call4papers" id="bg-call4paper"><span></span></div></a>
              </div>
              <div class="speaker-bio">
                <h3>Call 4 Papers</h3>
                <p>
                  Não deixe de <a href="https://docs.google.com/forms/d/e/1FAIpQLScvM9sctUCe2vjbUxv3QzhRimn5ztB7JyPgbnpTDksS3eTpQw/viewform">submeter</a> sua palestra com um conteúdo super criativo para, quem sabe, apresentá-lo a mais de 1500 pessoas na maior conferência de JavaScript do Universo!
                </p>
              </div>
            </div>
          </li>
      ...
      <div class="newsletter">
        <form id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" method="post" action="//braziljs.us5.list-manage.com/subscribe/post?u=77b6594f10bba05dcc722c80e&amp;id=e6beed4270">
          <div class="subscribe">
            ...
            <button type="submit" class="flow-opposite anchor-button anchor-button--color-4 anchor-button--size-2">Newsletter</button>
          </div>
        </form>
      </div>
