	...
	<section class="section-wrapper">
		<div class="content">
			<div class="center-elements--mobile">
				<h2 class="title" id="latest-courses-title">Próximos cursos</h2>
			</div>
			<ul class="calendar-list" aria-labelledby="latest-courses-title">
				<?php $firstEvent = true; ?>
				<?php while ( have_posts() ) : the_post(); ?>
					<?php
						...
						$columnCount = $firstEvent ? 'col-4-12' : 'col-4-12';
			...
			<div class="row center-elements">
				<a href="<?php bloginfo('url'); ?>/cursos" class="anchor-button">Veja todos os cursos</a>
			</div>
		</div>
	</section>
<?php endif; ?>
